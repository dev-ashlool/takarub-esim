...
/**
 * Authenticated customer My Orders and Order Details. Does not expose supplier or eSIM activation
 * secrets.
 */
@RestController
@RequestMapping("/api/v1/orders")
@Tag(name = "Customer Orders", description = "Authenticated customer My Orders and Order Details")
